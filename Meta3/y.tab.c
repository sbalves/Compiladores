...
#line 101 "gocompiler.y"
                                {(yyval.node) = newNode("VarDecl", NULL, 0); add_child((yyval.node), (yyvsp[0].node));
                                add_sibling((yyvsp[0].node), newNode("Id", (yyvsp[-1].value), 0));
                                }
#line 1657 "y.tab.c"
    break;
...
#line 105 "gocompiler.y"
                                {(yyval.node) = newNode("VarDecl", NULL, 0); aux = newNode("Id", (yyvsp[-2].value), 0); 
...
#line 115 "gocompiler.y"
                                        ...
                                        add_sibling(varspec_aux_1, newNode("Id", (yyvsp[-1].value), 0));
                                        }
#line 1679 "y.tab.c"
    break;
...
#line 119 "gocompiler.y"
                                        ...
                                        add_sibling(aux, newNode("Id", (yyvsp[0].value), 0)); 
                                        }
#line 1689 "y.tab.c"
    break;
...
#line 132 "gocompiler.y"
                                                                ...
                                                                aux2 = newNode("Id", (yyvsp[-5].value), 0);
                                                                add_child((yyval.node), aux);                                                                                
...
#line 141 "gocompiler.y"
                                                                {(yyval.node) = newNode("FuncDecl", NULL, 0);
                                                                aux = newNode("FuncHeader", NULL, 0);
                                                                aux2 = newNode("Id", (yyvsp[-4].value), 0);
                                                                add_child((yyval.node), aux);
                                                                add_sibling(aux, (yyvsp[0].node));
                                                                add_child(aux, aux2);
...
#line 149 "gocompiler.y"
                                                                ...
                                                                add_child(aux, aux2);
                                                                add_sibling(aux2, (yyvsp[-1].node));
                                                                add_sibling((yyvsp[-1].node), newNode("FuncParams", NULL, 0));
                                                                }
#line 1754 "y.tab.c"
    break;
...
#line 158 "gocompiler.y"
                                                                {(yyval.node) = newNode("FuncDecl", NULL, 0);
                                                                aux = newNode("FuncHeader", NULL, 0);
                                                                aux2 = newNode("Id", (yyvsp[-3].value), 0);
                                                                add_child((yyval.node), aux);
                                                                add_child(aux, aux2);
...
#line 168 "gocompiler.y"
                                                ...
                                                add_sibling((yyvsp[-1].node), newNode("Id", (yyvsp[-2].value), 0));
                                                }
#line 1779 "y.tab.c"
    break;
...
#line 194 "gocompiler.y"
                                                  {(yyval.node) = newNode("FuncBody", NULL, 0); add_child((yyval.node), (yyvsp[-1].node));}
#line 1815 "y.tab.c"
    break;
...
#line 203 "gocompiler.y"
                                                                        ...
                                                                        aux = newNode("Id", (yyvsp[-2].value), 0);
                                                                        add_child((yyval.node), aux);
                                                                        add_sibling(aux, (yyvsp[0].node));
                                                                        }
#line 1849 "y.tab.c"
...
#line 272 "gocompiler.y"
                                                                        {(yyval.node) = newNode("For", NULL, 0);
                                                                        add_child((yyval.node), (yyvsp[-2].node));
                                                                        add_sibling((yyvsp[-2].node), newNode("Block", NULL, 0));
                                                                        }
#line 1972 "y.tab.c"
    break;
...
#line 282 "gocompiler.y"
                                                                        {(yyval.node) = newNode("Return", NULL, 0);}
#line 1989 "y.tab.c"
    break;
...
#line 290 "gocompiler.y"
                                                                        {(yyval.node) = newNode("Print", NULL, 0);
                                                                        aux = newNode("StrLit", (yyvsp[-1].value), 0);
                                                                        add_child((yyval.node), aux);}
#line 2024 "y.tab.c"
    break;
...
#line 300 "gocompiler.y"
                                                                                ...
                                                                                aux = newNode("Id", (yyvsp[-10].value), 1);
                                                                                add_child((yyval.node), aux);
...
#line 305 "gocompiler.y"
                                                                                {(yyval.node) = newNode("ParseArgs", NULL, 1);
                                                                                aux = newNode("Id", (yyvsp[-7].value), 0);
                                                                                add_child((yyval.node), aux);
...
#line 313 "gocompiler.y"
                                                             {(yyval.node) = newNode("Id", (yyvsp[0].value), 0);}
#line 2069 "y.tab.c"
    break;
...
#line 319 "gocompiler.y"
                                                                {(yyval.node) = (yyvsp[-3].node); add_sibling((yyvsp[-3].node), newNode("Error", NULL, 0)); free_ast(program_root);}
#line 2093 "y.tab.c"
    break;
...
#line 327 "gocompiler.y"
                                {(yyval.node) = newNode("Or", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2111 "y.tab.c"
    break;

  case 64:
#line 328 "gocompiler.y"
                                {(yyval.node) = newNode("And", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2117 "y.tab.c"
    break;

  case 65:
#line 329 "gocompiler.y"
                                {(yyval.node) = newNode("Lt",NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2123 "y.tab.c"
    break;

  case 66:
#line 330 "gocompiler.y"
                                {(yyval.node) = newNode("Gt",NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2129 "y.tab.c"
    break;

  case 67:
#line 331 "gocompiler.y"
                                {(yyval.node) = newNode("Eq", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2135 "y.tab.c"
    break;

  case 68:
#line 332 "gocompiler.y"
                                {(yyval.node) = newNode("Ne", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2141 "y.tab.c"
    break;

  case 69:
#line 333 "gocompiler.y"
                                {(yyval.node) = newNode("Le", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2147 "y.tab.c"
    break;

  case 70:
#line 334 "gocompiler.y"
                                {(yyval.node) = newNode("Ge", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2153 "y.tab.c"
    break;

  case 71:
#line 335 "gocompiler.y"
                                {(yyval.node) = newNode("Add", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2159 "y.tab.c"
    break;

  case 72:
#line 336 "gocompiler.y"
                                {(yyval.node) = newNode("Sub", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2165 "y.tab.c"
    break;

  case 73:
#line 337 "gocompiler.y"
                                {(yyval.node) = newNode("Mul", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2171 "y.tab.c"
    break;

  case 74:
#line 338 "gocompiler.y"
                                {(yyval.node) = newNode("Div", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2177 "y.tab.c"
    break;

  case 75:
#line 339 "gocompiler.y"
                                {(yyval.node) = newNode("Mod", NULL, 1); add_child((yyval.node), (yyvsp[-2].node)); add_sibling((yyvsp[-2].node), (yyvsp[0].node));}
#line 2183 "y.tab.c"
    break;

  case 76:
#line 340 "gocompiler.y"
                                {(yyval.node) = newNode("Not", NULL, 1); add_child((yyval.node), (yyvsp[0].node));}
#line 2189 "y.tab.c"
    break;

  case 77:
#line 341 "gocompiler.y"
                                {(yyval.node) = newNode("Minus", NULL, 1); add_child((yyval.node), (yyvsp[0].node));}
#line 2195 "y.tab.c"
    break;

  case 78:
#line 342 "gocompiler.y"
                                {(yyval.node) = newNode("Plus", NULL, 1); add_child((yyval.node), (yyvsp[0].node));}
#line 2201 "y.tab.c"
    break;

  case 79:
#line 343 "gocompiler.y"
                                {(yyval.node) = newNode("IntLit", (yyvsp[0].value), 1);}
#line 2207 "y.tab.c"
    break;

  case 80:
#line 344 "gocompiler.y"
                                {(yyval.node) = newNode("RealLit", (yyvsp[0].value), 1);}
#line 2213 "y.tab.c"
    break;

  case 81:
#line 345 "gocompiler.y"
                                {(yyval.node) = newNode("Id", (yyvsp[0].value), 1);}
#line 2219 "y.tab.c"
    break;

  case 82:
#line 346 "gocompiler.y"
                                {(yyval.node) = newNode("Call", NULL, 1); add_child((yyval.node), (yyvsp[0].node));}
#line 2225 "y.tab.c"
    break;
